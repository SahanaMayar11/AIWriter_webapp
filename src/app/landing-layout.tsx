    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center bg-background fixed top-0 left-0 right-0 z-50 border-b">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6 items-center">
            ...
            <a href="/#why-choose-us" className="text-sm font-medium hover:underline underline-offset-4">About</a>
            <a href="#footer" className="text-sm font-medium hover:underline underline-offset-4">Contact</a>
        ...
        <div className="container mx-auto py-12 px-4 md:px-6">
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><a href="/#why-choose-us" className="text-sm text-muted-foreground hover:text-foreground">About</a></li>
                <li><a href="#footer" className="text-sm text-muted-foreground hover:text-foreground">Contact</a></li>
              </ul>
            </div>
          </div>
